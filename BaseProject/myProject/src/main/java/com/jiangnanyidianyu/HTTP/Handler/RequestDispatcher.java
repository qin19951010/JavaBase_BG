...
public class RequestDispatcher {
    public static String dispatch(Request request) throws IOException {
        ...
        {
            InputStream stream = Socket_Demo.class.getClassLoader().getResourceAsStream("com/jiangnanyidianyu/HTTP/Login.html");
