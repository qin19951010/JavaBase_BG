package com.jiangnanyidianyu.AboutReflection;
...
public class Apple {
    ...
    public static void main(String[] args) throws Exception{
        ...
        /**
        *   反射获取对象并调用方法
        *   1.通过Class.forName("com.jiangnanyidianyu.AboutReflection.Apple")获得Class对象
        ...
        */
        //2.使用反射调用
        Class clz = Class.forName("com.jiangnanyidianyu.AboutReflection.Apple");
